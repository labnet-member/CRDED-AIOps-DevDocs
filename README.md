...
- [ダッシュボード](https://aiops-monitoring.net.hiroshima-u.ac.jp/d/ad7rnqt/sindan-dashboard?orgId=1&from=now-30m&to=now&timezone=browser&var-sindanClientID=gumma-mon01&var-target_v4rtt_srv=1.1.1.1&var-target_v6rtt_srv=www.google.co.jp&var-target_v4pmtu=8.8.8.8&var-target_v6pmtu=2001:4860:4860::8888&var-target_v4http_srv=www.wide.ad.jp&var-target_v6http_srv=www.wide.ad.jp&refresh=auto) からリアルタイムにデータを閲覧可能（詳細は [ここ](https://github.com/labnet-member/CRDED-AIOps-DevDocs/blob/main/docs/visualization/dashboard.md) を参照）

- LLMを活用し，直近のデータに基づいてネットワーク環境に関する個別フィードバックを提供（今後の取り組み）
...
| [docs/visualization/](https://github.com/labnet-member/CRDED-AIOps-DevDocs/tree/main/docs/visualization) | （※引継ぎ事項あり）InfluxDB + Grafana による計測データの可視化設定手順 |
